...
public class OI {
    ...
    public OI() {
        ...
        entireHabLiftUpAndDown.toggleWhenPressed(new EntireHabLiftUpDown());
        // frontHabLiftUpAndDown.whenPressed(new HabLiftFrontUpDown());
        // backHabLiftUpAndDown.whenPressed(new HabLiftBackUpDown());
