...
public class OI {
    ...
    public OI() {
        ...
        entireHabLiftUpAndDown.toggleWhenPressed(new HabLiftUpDown());
        frontHabLiftUpAndDown.toggleWhenPressed(new HabLiftFrontUpDown());
        backHabLiftUpAndDown.toggleWhenPressed(new HabLiftBackUpDown());
