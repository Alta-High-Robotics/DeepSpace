...
public class DriveTrain extends Subsystem {
    ...
    private WPI_TalonSRX rightSideTalon;
    ...
    public DriveTrain() {
        ...
        leftDriveTalon = new WPI_TalonSRX(8);
        leftDriveVictor = new WPI_VictorSPX(1);
        leftDriveVictor.set(ControlMode.Follower, 8);
        
        rightSideTalon = new WPI_TalonSRX(10);

        rightSideVictor = new WPI_VictorSPX(9);
        rightSideVictor.set(ControlMode.Follower, 10);
        
        
        
        drive = new DifferentialDrive(leftDriveTalon, rightSideTalon);
